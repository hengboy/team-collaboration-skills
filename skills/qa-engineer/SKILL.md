...
```bash
# 正确 ✅
.collaboration/features/mobile-login/test-cases.md
.collaboration/features/mobile-login/tests/login.test.ts
.collaboration/features/payment-refund/test-cases.md

# 错误 ❌
./test-cases.md             # 输出到当前目录
tests/                      # 缺少 .collaboration/features/{feature-name}
```
...
@.collaboration/features/{feature-name}/stories.md
...
**技术栈：** 代码审查工具、安全扫描工具、性能分析工具

> 💡 **操作提示：** 回复 **"是"** 或 **"继续"** 进入 Code Reviewer 流程，我将切换至代码审查专家角色开始代码审查。
